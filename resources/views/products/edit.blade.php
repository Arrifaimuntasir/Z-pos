            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6 mt-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="cost_price" class="form-control border-start-0 @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', $product->cost_price) }}" min="0" required>
                    </div>
