...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0 text-dark">Suppliers</h4>
        <span class="text-muted small">Manage your suppliers and distributors</span>
    </div>
    <div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light text-muted">
                    <tr>
                        <th class="ps-4 fw-medium border-0 rounded-start" style="padding-top: 15px; padding-bottom: 15px;">Supplier Name</th>
                        <th class="fw-medium border-0">Contact Person</th>
                ...
                <tbody class="border-top-0">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">
                            ...
                            <p class="small mb-0">Start by adding your first supplier.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
