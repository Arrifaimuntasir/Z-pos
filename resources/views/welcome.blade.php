...
<style>
/* ======================================
   Z-POS LANDING PAGE – DESIGN UPGRADE
   Colors: Navy #0f172a · Green #10b981
   No purple. No AI features.
   ====================================== */

/* ---- HERO ---- */
.hero-section {
    background: linear-gradient(150deg, #0f172a 0%, #0d2137 50%, #052e1c 100%) !important;
...
.hero-section .container { padding-top: 120px; padding-bottom: 80px; }
...
.hero-section .row.mt-5.pt-3 { border-top: 1px solid rgba(255,255,255,0.08) !important; }
.hero-section .border-end.border-light { border-color: rgba(255,255,255,0.08) !important; }

/* Hero image */
.hero-section .hero-image {
    border-radius: 16px !important;
    box-shadow: 0 40px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.06) !important;
...
section.py-5.border-bottom.bg-white .col-md-2:hover { opacity: 0.9; }
section.py-5.border-bottom.bg-white h5 { font-size: 0.9rem; margin-bottom: 4px !important; }

/* ---- FEATURES ---- */
#features.py-5.bg-light { padding: 80px 0 !important; }
#features .container.py-5 { padding: 0 var(--bs-gutter-x, .75rem) !important; }
...
.feature-box p { font-size: 0.85rem !important; line-height: 1.7 !important; }

/* ---- STATISTICS ---- */
section.py-5.text-white {
    padding: 70px 0 !important;
    background: linear-gradient(135deg, #0f172a, #0d2137) !important;
    position: relative;
    overflow: hidden;
}
...
section.py-5.text-white p { font-size: 0.72rem !important; letter-spacing: 1.5px; color: #64748b !important; }

/* ---- TESTIMONIALS ---- */
#testimonials.py-5.bg-white { padding: 80px 0 !important; }
#testimonials .container.py-5 { padding: 0 var(--bs-gutter-x,.75rem) !important; }
#testimonials h2 { font-size: clamp(1.8rem, 4vw, 2.4rem) !important; font-weight: 800 !important; }
...
.testimonial-card .client-info h5 { font-size: 0.88rem !important; }
.testimonial-card .client-info span { font-size: 0.72rem !important; }

/* Add star rating before each testimonial */
...
/* ---- PRICING ---- */
#pricing.py-5.bg-light { padding: 80px 0 !important; }
#pricing .container.py-5 { padding: 0 var(--bs-gutter-x,.75rem) !important; }
#pricing h2 { font-size: clamp(1.8rem, 4vw, 2.4rem) !important; font-weight: 800 !important; }
...
.pricing-card:not(.popular):hover {
    border-color: #10b981 !important;
    box-shadow: 0 12px 40px rgba(16,185,129,0.1) !important;
    transform: translateY(-4px);
}
.pricing-card.popular {
    border: 2px solid #10b981 !important;
    box-shadow: 0 12px 40px rgba(16,185,129,0.15) !important;
    background: linear-gradient(180deg, rgba(16,185,129,0.04) 0%, #fff 35%) !important;
}
.pricing-card .price {
...
/* ---- FAQ ---- */
section.py-5.bg-white:last-of-type { padding: 70px 0 !important; }
...
.display-5 { font-size: clamp(1.8rem, 4vw, 2.4rem) !important; font-weight: 800 !important; letter-spacing: -0.5px; }
.display-6 { font-size: clamp(1.6rem, 3.5vw, 2rem) !important; font-weight: 800 !important; letter-spacing: -0.5px; }

/* Responsive */
@media (max-width: 768px) {
    .hero-section .container { padding-top: 100px !important; padding-bottom: 60px !important; }
    .hero-section .hero-image { margin-top: 32px; }
    .feature-box { padding: 18px !important; }
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="testimonial-card position-relative h-100">
                        ...
                        <div class="client-info">
                            ...
                            <div>
                                <h5>{{ __('Yassir Zahor') }}</h5>
                                <span>{{ __('Owner, YZ Pharmacies') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="testimonial-card position-relative h-100">
                        ...
                        <div class="client-info">
                            ...
                            <div>
                                <h5>{{ __('Arrifai Muntasir') }}</h5>
                                <span>{{ __('Manager, AM Supermarket') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="testimonial-card position-relative h-100">
                        ...
                        <div class="client-info">
                            ...
                            <div>
                                <h5>{{ __('Zakom Shop') }}</h5>
                                <span>{{ __('Director, Wholesale') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
