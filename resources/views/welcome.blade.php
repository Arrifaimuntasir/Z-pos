...
/* icon color variants */
.fi-purple { background: #d1fae5; color: #059669; }
...
.fi-indigo { background: #d1fae5; color: #0d9488; }
...
.price-card.featured {
    border-color: #0f172a;
    background: linear-gradient(180deg, #d1fae5 0%, #fff 40%);
...
.faq-item:hover { border-color: #0f172a; }
.faq-question {
    display: flex;
    align-items: center;
...
.faq-item.open .faq-icon { transform: rotate(45deg); background: #d1fae5; }
...
.btn-cta-white:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(0,0,0,0.25); color: #0f172a; }
            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="900">
                ...
                <div class="hero-btns">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#demoVideoModal" class="btn-ghost">
                        <i class="bi bi-play-circle-fill" style="color:#34d399;"></i>
                ...
                <div class="hero-stats">
                    ...
                    <div>
                        <div class="hero-stat-value">4.8 Γ¡É</div>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            $features = [
                ...
                ['icon'=>'bi-printer','color'=>'fi-teal','title'=>'Hardware Integrated','desc'=>'Plug and play with thermal receipt printers, cash drawers, customer displays, and external barcode scanners without hassle.'],
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $i * 100 }}">
                <div class="testi-card">
                    <div class="testi-stars">ΓÿàΓÿàΓÿàΓÿàΓÿà</div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="price-card featured">
                    <div class="price-badge">Γ¡É {{ __('MOST POPULAR') }}</div>
                    <div class="price-name" style="color: #0f172a;">{{ __('Professional') }}</div>
                    <div class="price-amount" style="color: #0f172a;">TSh 45K<small>/mo</small></div>
...
<section class="cta-wrap">
    <div class="container position-relative" style="z-index:1;">
        ...
        <a href="{{ route('register') }}" class="btn-cta-white">
            <i class="bi bi-rocket-takeoff-fill"></i>
            {{ __('Start free trial') }} ΓÇö 7 {{ __('Days Free') }}
        </a>
    </div>
</section>
