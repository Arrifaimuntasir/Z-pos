    ...
    <section class="py-5 bg-light">
        <div class="container py-5 bg-white shadow-sm rounded-4 p-4 p-md-5" style="max-width: 900px;" data-aos="fade-up">
            ...
            <div style="line-height: 1.8; color: #333; font-size: 1.1rem;" class="mt-4">
                <h4 class="text-dark fw-bold mt-5 mb-3">1. Introduction</h4>
                <p>Welcome to Z-pos. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>

                <h4 class="text-dark fw-bold mt-5 mb-3">2. The Data We Collect About You</h4>
                ...
                <h4 class="text-dark fw-bold mt-5 mb-3">3. How We Use Your Personal Data</h4>
                ...
                <h4 class="text-dark fw-bold mt-5 mb-3">4. Data Security</h4>
                <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorised way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>

                <h4 class="text-dark fw-bold mt-5 mb-3">5. Data Retention</h4>
