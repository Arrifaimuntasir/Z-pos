    ...
    <section class="py-5 bg-light">
        <div class="container py-5">
            <div class="text-center mb-5" data-aos="fade-up">
                <h2 class="fw-bold text-primary display-5">{{ CmsSetting::get('contact', 'page_title', 'Get in Touch') }}</h2>
                <p class="text-muted fs-5 mt-3">{{ CmsSetting::get('contact', 'page_subtitle', "We'd love to hear from you.") }}</p>
            </div>
                            ...
                            <div class="col-md-5 border-md-end pe-md-4">
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">{{ CmsSetting::get('contact', 'address', 'Uhuru Plaza Kkoo, Dar es Salaam, Tanzania') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">{{ CmsSetting::get('contact', 'email', 'info@z-pos.co.tz') }}</p>
                                    </div>
                                </div>
