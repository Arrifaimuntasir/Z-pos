...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3 d-print-none">
    <div>
        <h4 class="fw-bold mb-0 text-dark">Invoice</h4>
        <span class="text-muted small">View transaction details</span>
    </div>
    <div>
        <a href="{{ route('invoices.index') }}" class="btn btn-light border bg-white shadow-sm rounded-pill px-3" style="font-weight: 500; font-size: 14px;"><i class="bi bi-arrow-left me-1"></i> Back</a>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-body p-5" id="invoiceArea">
                ...
                <div class="text-center border-bottom pb-4 mb-4">
                    ...
                    @if($invoice->shop && $invoice->shop->tin_number)
                        <p class="text-muted mb-0">TIN: {{ $invoice->shop->tin_number }}</p>
                    @endif
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-6 text-sm-end mt-4 mt-sm-0">
                        <h6 class="fw-bold text-muted small text-uppercase mb-1">Invoice Details:</h6>
