...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3 d-print-none">
    <div>
        <h4 class="fw-bold mb-0 text-dark">{{ __('Sale Receipt') }}</h4>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-6 text-sm-end mt-4 mt-sm-0">
                        @if($sale->payment_status == 'proforma')
                            <h6 class="fw-bold text-info small text-uppercase mb-1">{{ __('Pro-Forma Invoice:') }}</h6>
                        @else
                            <h6 class="fw-bold text-muted small text-uppercase mb-1">{{ __('Receipt Details:') }}</h6>
                        @endif
                    ...
                    <div class="col-sm-5">
                        ...
                        @else
                            <div class="d-flex justify-content-between text-info">
                                ...
                                <span class="fw-bold">{{ __('PRO-FORMA') }}</span>
                            </div>
                        @endif
                    </div>
                </div>
