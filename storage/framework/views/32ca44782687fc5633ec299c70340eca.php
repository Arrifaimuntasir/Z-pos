...
<head>
    ...
    <title>Warranty Certificate - <?php echo e($warranty->warranty_number); ?></title>
...
<body>
    ...
    <div class="print-btn-container d-flex gap-2">
        <a href="<?php echo e(route('warranties.pdf', $warranty->id)); ?>?v=<?php echo e(time()); ?>" class="btn btn-sm btn-danger shadow-sm px-3" style="border-radius: 6px;">
            <i class="bi bi-file-earmark-pdf"></i> <?php echo e(__('PDF')); ?>

        </a>
        <button onclick="window.print()" class="btn btn-sm btn-primary shadow-sm px-3" style="border-radius: 6px;">
            <i class="bi bi-printer"></i> <?php echo e(__('Print Certificate')); ?>
    ...
    <div class="certificate-wrapper theme-<?php echo e($warranty->design_theme); ?>">
        <?php if($warranty->design_theme == 6): ?>
            <div class="inner-border"></div>
        <?php endif; ?>
        
        <div class="cert-content">
            <div class="cert-header">
                <?php if($warranty->shop->logo_path): ?>
                    <img src="<?php echo e(asset($warranty->shop->logo_path)); ?>" alt="Logo" class="cert-logo">
                <?php else: ?>
                    <h5 style="font-weight: 900; letter-spacing: 2px; margin-bottom: 5px; margin-top:0;"><?php echo e($warranty->shop->name); ?></h5>
                <?php endif; ?>
                <div class="cert-title"><?php echo e(__('WARRANTY CERTIFICATE')); ?></div>
                <div class="cert-subtitle"><?php echo e(__('Official Document of Guarantee')); ?></div>
                
                <div style="margin-top: 10px; font-size: 10px; opacity: 0.8; font-weight: bold;">
                    <?php echo e(__('Warranty No:')); ?> <span style="font-size: 12px; color: #000;"><?php echo e($warranty->warranty_number); ?></span>
                </div>
            </div>
            ...
            <div class="cert-body">
                <div class="row-info">
                    <div class="col-info" style="width: 50%;">
                        <div class="info-label"><?php echo e(__('Customer Name')); ?></div>
                        <div class="info-value"><?php echo e($warranty->customer_name ?: 'Valued Customer'); ?></div>
                    </div>
                    <div class="col-info" style="width: 50%;">
                        <div class="info-label"><?php echo e(__('Customer Phone')); ?></div>
                        <div class="info-value"><?php echo e($warranty->customer_phone ?: 'N/A'); ?></div>
                    </div>
                </div>

                <div class="row-info">
                    <div class="col-info" style="width: 50%;">
                        <div class="info-label"><?php echo e(__('Region')); ?></div>
                        <div class="info-value"><?php echo e($warranty->region ?: 'N/A'); ?></div>
                    </div>
                    <div class="col-info" style="width: 50%;">
                        <div class="info-label"><?php echo e(__('Gender')); ?></div>
                        <div class="info-value"><?php echo e($warranty->gender ?: 'N/A'); ?></div>
                    </div>
                </div>
                ...
                <div class="row-info">
                    <div class="col-info" style="width: 40%;">
                        ...
                        <div class="info-value"><?php echo e($warranty->product_name); ?></div>
                    </div>
                    <div class="col-info" style="width: 30%;">
                        <div class="info-label">Price (TZS)</div>
                        <div class="info-value"><?php echo e($warranty->price ? number_format($warranty->price) : 'N/A'); ?></div>
                    </div>
                    <div class="col-info" style="width: 30%;">
                        <div class="info-label">Serial Number / IMEI</div>
                        <div class="info-value"><?php echo e($warranty->serial_number ?: 'N/A'); ?></div>
                    </div>
                </div>

                <div class="row-info">
                    <div class="col-info" style="width: 33.3%;">
                        <div class="info-label"><?php echo e(__('Duration')); ?></div>
                        <div class="info-value"><?php echo e($warranty->duration); ?></div>
                    </div>
                    <div class="col-info" style="width: 33.3%;">
                        <div class="info-label"><?php echo e(__('Valid From')); ?></div>
                        <div class="info-value"><?php echo e($warranty->start_date->format('d M, Y')); ?></div>
                    </div>
                    <div class="col-info" style="width: 33.3%;">
                        <div class="info-label"><?php echo e(__('Valid Until')); ?></div>
                        <div class="info-value"><?php echo e($warranty->end_date->format('d M, Y')); ?></div>
                    </div>
                </div>

                <?php if($warranty->conditions): ?>
                <div style="margin-top: 5px;">
                    <div class="info-label" style="margin-bottom: 3px;"><?php echo e(__('Terms and Conditions')); ?></div>
                    <div class="terms-box">
                        <?php echo $warranty->conditions; ?>
            ...
            <div class="cert-footer">
                <div style="text-align: center;">
                    <div class="info-label"><?php echo e(__('Date Issued')); ?></div>
                    <div style="font-weight: bold; font-size: 13px;"><?php echo e($warranty->created_at->format('d M, Y')); ?></div>
                </div>
                <div style="text-align: center;">
                    <div class="info-label"><?php echo e(__('Issued By')); ?></div>
                    <div style="font-weight: bold; font-size: 13px;"><?php echo e($warranty->shop->name); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\Z-pos\resources\views\warranties\show.blade.php ENDPATH**/ ?>