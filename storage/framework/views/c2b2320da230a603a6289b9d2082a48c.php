...
<?php $__env->startSection('title', 'Business Card Designer'); ?>
        ...
        <div class="editor-sidebar">
                ...
                <div class="accordion-item">
                    ...
                    <div id="acc-info" class="accordion-collapse collapse show" data-bs-parent="#editorAccordion">
                        <div class="accordion-body">
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Business Name')); ?></label>
                                <input type="text" class="form-control" id="inp-name" value="<?php echo e($shop->name); ?>">
                            </div>
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Tagline')); ?></label>
                                <input type="text" class="form-control" id="inp-tagline" value="<?php echo e($shop->card_message ?? 'Scan for Details'); ?>">
                            </div>
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Phone')); ?></label>
                                <input type="text" class="form-control" id="inp-phone" value="<?php echo e($shop->card_phone ?? $shop->phone); ?>">
                            </div>
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Email')); ?></label>
                                <input type="email" class="form-control" id="inp-email" value="<?php echo e($shop->card_email ?? $userEmail); ?>">
                            </div>
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Address')); ?></label>
                                <input type="text" class="form-control" id="inp-address" value="<?php echo e($shop->address ?? 'Main Street, City'); ?>">
                            </div>
                            <div class="mb-2">
                                <label class="form-label"><?php echo e(__('Social Username')); ?></label>
                                <input type="text" class="form-control" id="inp-social" value="<?php echo e(strtolower(str_replace(' ', '_', $shop->name))); ?>">
                            </div>
                            <div class="mb-2 mt-3 p-2 border rounded" style="background:#f8fafc">
                                <label class="form-label text-primary" style="font-size:0.85rem;"><i class="bi bi-image me-1"></i><?php echo e(__('Custom Logo (Optional)')); ?></label>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#acc-brand">
                            <i class="bi bi-palette-fill me-2"></i> <?php echo e(__('Colors & Font')); ?>
                    ...
                    <div id="acc-brand" class="accordion-collapse collapse" data-bs-parent="#editorAccordion">
                        <div class="accordion-body">
                            ...
                            <label class="form-label mb-2"><?php echo e(__('Card Colors')); ?></label>
                            <div class="color-row">
                                <div class="color-picker-item">
                                    <div class="color-swatch"><input type="color" id="inp-color-primary" value="<?php echo e($shop->card_color ?? '#3b82f6'); ?>"></div>
                                ...
                                <div class="color-picker-item">
                                    ...
                                    <label><?php echo e(__('Accent')); ?></label>
                                </div>
                            </div>

                            <label class="form-label mt-2"><?php echo e(__('Typography')); ?></label>
                            ...
                            <div class="mt-3 p-2 rounded d-flex align-items-center gap-2" style="background: #eff6ff; font-size: 0.78rem; color: #1d4ed8;">
                                ...
                                <span><?php echo e(__('Logo loads from your Shop Settings automatically, or use the custom upload above.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-3 border-top" style="background: #f8fafc; border-radius: 0 0 16px 16px;">
                <button class="action-btn btn-save w-100" id="btn-save">
                    <i class="bi bi-cloud-check-fill"></i> <?php echo e(__('Save Design')); ?>
            ...
            <div class="card-scene w-100">
                <div class="d-flex gap-2 mb-4 justify-content-center flex-wrap w-100">
                    <button class="action-btn btn-flip" id="btn-flip">
                        <i class="bi bi-arrow-repeat"></i> <?php echo e(__('Flip Card')); ?>

                    </button>
                    <button class="action-btn btn-download" id="btn-dl-png">
                        <i class="bi bi-download"></i> <?php echo e(__('Download Image')); ?>
                ...
                <div id="export-status" class="mt-3 text-primary fw-bold d-none" style="font-size: 0.85rem;">
                    <span class="spinner-border spinner-border-sm me-2"></span> <?php echo e(__('Generating download...')); ?>
                ...
                <p class="mt-3 mb-0 text-center text-muted" style="font-size: 0.78rem; max-width: 340px;">
                    ...
                    <?php echo e(__('QR code on the back lets customers instantly save your contact to their phone.')); ?>
...
<input type="hidden" id="sys-logo" value="<?php echo e($shop->card_logo ? asset('storage/' . $shop->card_logo) : ($shop->logo ? asset('storage/' . $shop->logo) : '')); ?>">
<input type="hidden" id="sys-qr" value="<?php echo e($qrCode); ?>">
<input type="hidden" id="sys-cat" value="<?php echo e($cat); ?>">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('btn-save').addEventListener('click', function() {
        ...
        this.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span><?php echo e(__("Saving...")); ?>';
        this.disabled = true;

        fetch('<?php echo e(route("shop.business-card.save")); ?>', {
            method: 'POST',
        ...
        .then(d => {
            if (d.success) {
                this.innerHTML = '<i class="bi bi-check-circle-fill me-2"></i><?php echo e(__("Saved!")); ?>';
                this.style.background = '#059669';
                setTimeout(() => { this.innerHTML = orig; this.style.background = ''; this.disabled = false; }, 2500);
            } else {
                alert(d.message || '<?php echo e(__("Error saving.")); ?>'); this.innerHTML = orig; this.disabled = false;
            }
        })
    ...
    const savedTheme = '<?php echo e($shop->card_theme); ?>';
    if (savedTheme) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\shop\business_card.blade.php ENDPATH**/ ?>