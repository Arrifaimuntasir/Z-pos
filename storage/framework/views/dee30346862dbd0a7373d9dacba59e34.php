...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $staff->name)); ?>" required placeholder="<?php echo e(__('e.g. arrifai muntasir')); ?>">
                        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', $staff->email)); ?>" required placeholder="staff@example.com">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold"><?php echo e(__('New Password')); ?> <span class="text-muted fw-normal">(Leave blank to keep current)</span></label>
                        <div class="input-group">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Minimum 8 characters')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold"><?php echo e(__('Confirm New Password')); ?></label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-lock"></i></span>
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control bg-light border-start-0 border-end-0" placeholder="<?php echo e(__('Type new password again')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 pt-2 border-top">
                        <button type="submit" class="btn btn-primary px-5 py-2 fw-semibold w-100" style="border-radius: 8px;">
                            <i class="bi bi-check2-circle me-2"></i> <?php echo e(__('Update Account')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\staff\edit.blade.php ENDPATH**/ ?>