...
<head>
    <meta charset="utf-8">
    <title>Warranty <?php echo e($warranty->warranty_number); ?></title>
    <style>
...
<body>
    ...
    <div class="certificate-wrapper theme-<?php echo e($warranty->design_theme ?? 1); ?>">
        <div class="cert-header">
            <?php if(isset($shop) && $shop->logo_path): ?>
                <?php 
                ...
                ?>
                <?php if($base64): ?>
                    <img src="<?php echo e($base64); ?>" alt="Logo" style="max-height: 60px; margin-bottom: 10px;">
                <?php else: ?>
                    <h2 style="margin: 0; margin-bottom: 10px; text-transform: uppercase;"><?php echo e($shop->name); ?></h2>
                <?php endif; ?>
            <?php elseif(isset($shop)): ?>
                <h2 style="margin: 0; margin-bottom: 10px; text-transform: uppercase;"><?php echo e($shop->name); ?></h2>
            <?php endif; ?>
            <h1><?php echo e(__('Warranty Certificate')); ?></h1>
            <p><?php echo e(__('Official Coverage Document')); ?></p>
        </div>
        
        <table class="info-table">
            <tr>
                <td>
                    <span class="label"><?php echo e(__('Warranty Number')); ?></span>
                    <div class="value"><?php echo e($warranty->warranty_number); ?></div>
                </td>
                <td>
                    <span class="label"><?php echo e(__('Customer Name')); ?></span>
                    <div class="value">
                        <?php echo e($warranty->customer_name ?? 'N/A'); ?>

                        <?php if($warranty->customer_phone): ?>
                            <br><small style="font-size: 11px; font-weight: normal;"><?php echo e($warranty->customer_phone); ?></small>
                        <?php endif; ?>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="label"><?php echo e(__('Region')); ?></span>
                    <div class="value"><?php echo e($warranty->region ?? 'N/A'); ?></div>
                </td>
                <td>
                    <span class="label"><?php echo e(__('Gender')); ?></span>
                    <div class="value"><?php echo e($warranty->gender ?? 'N/A'); ?></div>
                </td>
            </tr>
            <tr>
                <td style="width: 40%;">
                    <span class="label"><?php echo e(__('Product Covered')); ?></span>
                    <div class="value"><?php echo e($warranty->product_name); ?></div>
                </td>
                <td style="width: 30%;">
                    <span class="label">Price (TZS)</span>
                    <div class="value"><?php echo e($warranty->price ? number_format($warranty->price) : 'N/A'); ?></div>
                </td>
                <td style="width: 30%;">
                    <span class="label">Serial / IMEI Number</span>
                    <div class="value"><?php echo e($warranty->serial_number ?? 'N/A'); ?></div>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="label"><?php echo e(__('Duration')); ?></span>
                    <div class="value"><?php echo e($warranty->duration); ?></div>
                </td>
                <td colspan="2">
                    <span class="label"><?php echo e(__('Valid Until')); ?></span>
                    <div class="value"><?php echo e(\Carbon\Carbon::parse($warranty->end_date)->format('d M Y')); ?></div>
                </td>
            </tr>
        </table>
        ...
        <div class="terms-box">
            <strong style="display:block; margin-bottom: 5px; font-size: 12px;"><?php echo e(__('Terms & Conditions:')); ?></strong>
        ...
        <table class="footer-table">
            <tr>
                <td style="text-align: left;">
                    <div class="label"><?php echo e(__('Date Issued')); ?></div>
                    <div style="font-size: 13px; font-weight: bold;"><?php echo e($warranty->created_at->format('d M Y')); ?></div>
                </td>
                <td style="text-align: right;">
                    <div class="label"><?php echo e(__('Issued By')); ?></div>
                    <div style="font-size: 13px; font-weight: bold;"><?php echo e($warranty->shop->name); ?></div>
                </td>
            </tr>
        </table>
    </div>
...
<?php /**PATH E:\Z-pos\resources\views\pdf\warranty.blade.php ENDPATH**/ ?>