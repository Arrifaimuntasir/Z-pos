...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="fw-bold mb-0">Edit Product: <?php echo e($product->name); ?></h4>
</div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sku', $product->sku)); ?>" required>
                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php
                    $productBranchId = $product->branches->first()->id ?? null;
                ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>" <?php echo e(old('branch_id', $productBranchId) == $branch->id ? 'selected' : ''); ?>><?php echo e($branch->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('model', $product->model)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($unit->id); ?>" <?php echo e((old('unit_id', $product->unit_id) == $unit->id) ? 'selected' : ''); ?>><?php echo e($unit->name); ?> (<?php echo e($unit->short_name); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stock', $product->stock)); ?>" min="0" id="stock_input">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('cost_price', $product->cost_price)); ?>" min="0">
                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('selling_price', $product->selling_price)); ?>" min="0" required>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check form-switch mt-1">
                            <input class="form-check-input" type="checkbox" role="switch" id="track_stock" name="track_stock" value="1" <?php echo e(old('track_stock', $product->track_stock) ? 'checked' : ''); ?> onchange="toggleRecipeSection()">
                ...
                <?php if(auth()->check() && auth()->user()->shop && auth()->user()->shop->business_type == 'Restaurant / Food'): ?>
                <div class="col-md-12" id="recipe_section" style="display: <?php echo e(old('track_stock', $product->track_stock) ? 'block' : 'none'); ?>;">
                    <div class="card bg-light border-0">
                        <div class="card-body">
                            ...
                            <div id="ingredients_container">
                                <?php $__currentLoopData = $product->ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row g-2 mb-2 ingredient-row" id="ingredient_row_<?php echo e($index); ?>">
                                        <div class="col-md-7">
                                            <select name="ingredients[<?php echo e($index); ?>][id]" class="form-select form-select-sm" required>
                                                ...
                                                <?php $__currentLoopData = $allProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($p->id); ?>" <?php echo e($ing->ingredient_id == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?> (Stock: <?php echo e($p->stock); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" step="0.001" name="ingredients[<?php echo e($index); ?>][quantity]" class="form-control form-control-sm" value="<?php echo e($ing->quantity); ?>" required>
                                        </div>
                                        <div class="col-md-1">
                                            <button type="button" class="btn btn-sm btn-outline-danger w-100" onclick="document.getElementById('ingredient_row_<?php echo e($index); ?>').remove()">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('expiry_date', $product->expiry_date)); ?>" <?php if($shopCategory == 'Pharmacy / Health'): ?> required <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div class="form-check form-switch mt-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="requires_imei" name="requires_imei" value="1" <?php echo e(old('requires_imei', $product->requires_imei) ? 'checked' : ''); ?>>
            ...
            <div class="d-flex justify-content-end pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary px-4"><?php echo e(__('Update Product')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<script>
    let ingredientIndex = <?php echo e($product->ingredients->count() > 0 ? $product->ingredients->count() : 0); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\products\edit.blade.php ENDPATH**/ ?>