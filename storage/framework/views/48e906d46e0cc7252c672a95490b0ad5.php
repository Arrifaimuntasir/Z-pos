<?php $__env->startSection('title', __('Edit Warrant')); ?>
...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3">
    <div class="d-flex align-items-center">
        ...
        <h4 class="fw-bold mb-0 text-dark" style="letter-spacing: -0.5px;"><?php echo e(__('Edit Warrant')); ?>: <?php echo e($warranty->warranty_number); ?></h4>
    </div>
...
<form action="<?php echo e(route('warranties.update', $warranty->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="warrant-card mb-4">
        ...
        <div class="section-title">
            <i class="bi bi-person-badge"></i> <?php echo e(__('Customer Details')); ?>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="customer_phone" class="form-control" value="<?php echo e(old('customer_phone', $warranty->customer_phone)); ?>">
            </div>
            <div class="col-md-6">
                <label class="form-label"><?php echo e(__('Customer Name')); ?> *</label>
                <input type="text" name="customer_name" class="form-control" value="<?php echo e(old('customer_name', $warranty->customer_name)); ?>">
            </div>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <select name="region" class="form-select">
                    ...
                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($region); ?>" <?php echo e(old('region', $warranty->region) == $region ? 'selected' : ''); ?>><?php echo e($region); ?></option>
            ...
            <div class="col-md-6">
                ...
                <select name="gender" class="form-select">
                    ...
                    <option value="Male" <?php echo e(old('gender', $warranty->gender) == 'Male' ? 'selected' : ''); ?>>Male</option>
                    <option value="Female" <?php echo e(old('gender', $warranty->gender) == 'Female' ? 'selected' : ''); ?>>Female</option>
                </select>
            </div>
        </div>
        ...
        <!-- Product Section -->
        <div class="section-title">
            <i class="bi bi-box-seam"></i> <?php echo e(__('Product Details')); ?>
            ...
            <div class="col-md-6">
                ...
                <select name="product_name" class="form-select product-select" required style="width: 100%;">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($product->name); ?>" <?php echo e(old('product_name', $warranty->product_name) == $product->name ? 'selected' : ''); ?>><?php echo e($product->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-6">
                <label class="form-label"><?php echo e(__('IMEI / Serial No.')); ?></label>
                <input type="text" name="serial_number" class="form-control" value="<?php echo e(old('serial_number', $warranty->serial_number)); ?>">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                ...
                <select name="duration" id="durationSelect" class="form-select" required onchange="calculateExpiry()">
                    <option value="7 Days" <?php echo e(old('duration', $warranty->duration) == '7 Days' ? 'selected' : ''); ?>>7 Days</option>
                    <option value="14 Days" <?php echo e(old('duration', $warranty->duration) == '14 Days' ? 'selected' : ''); ?>>14 Days</option>
                    <option value="1 month" <?php echo e(old('duration', $warranty->duration) == '1 month' ? 'selected' : ''); ?>>1 month</option>
                    <option value="3 months" <?php echo e(old('duration', $warranty->duration) == '3 months' ? 'selected' : ''); ?>>3 months</option>
                    <option value="6 months" <?php echo e(old('duration', $warranty->duration) == '6 months' ? 'selected' : ''); ?>>6 months</option>
                    <option value="12 months" <?php echo e(old('duration', $warranty->duration) == '12 months' ? 'selected' : ''); ?>>12 months</option>
                </select>
            </div>
            <div class="col-md-6">
                <label class="form-label"><i class="bi bi-calendar-event"></i> <?php echo e(__('Expiry Date')); ?></label>
                <input type="date" name="end_date" id="endDateInput" class="form-control bg-light" value="<?php echo e(old('end_date', $warranty->end_date->format('Y-m-d'))); ?>" required readonly>
            </div>
        </div>
        ...
        <script>
            function calculateExpiry() {
                ...
                const startDateStr = "<?php echo e($warranty->start_date->format('Y-m-d')); ?>";
        ...
        <div class="mb-4">
            <textarea id="summernote" name="conditions"><?php echo old('conditions', $warranty->conditions); ?></textarea>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="form-check theme-card border rounded-3 p-2 d-flex align-items-center h-100" style="cursor: pointer;" onclick="document.getElementById('theme<?php echo e($id); ?>').checked = true; updateThemeSelection();">
                    <input class="form-check-input me-2 ms-1 theme-radio flex-shrink-0" type="radio" name="design_theme" id="theme<?php echo e($id); ?>" value="<?php echo e($id); ?>" <?php echo e(old('design_theme', $warranty->design_theme) == $id ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\warranties\edit.blade.php ENDPATH**/ ?>