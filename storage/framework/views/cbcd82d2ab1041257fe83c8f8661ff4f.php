...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3 d-print-none">
    <div>
        <h4 class="fw-bold mb-0 text-dark"><?php echo e(__('Invoice')); ?></h4>
        <span class="text-muted small"><?php echo e(__('View transaction details')); ?></span>
    </div>
    <div>
        
        <a href="<?php echo e(route('sales.returns.create', $invoice->id)); ?>" class="btn btn-warning px-3 shadow-sm text-dark" style="border-radius: 8px;">
            <i class="bi bi-arrow-return-left me-1"></i> <?php echo e(__('Return/Refund')); ?>

        </a>
        <a href="<?php echo e(route('invoices.pdf', $invoice->id)); ?>?v=<?php echo e(time()); ?>" class="btn btn-danger px-3 shadow-sm" style="border-radius: 8px;">
...
<div class="row justify-content-center">
    <div class="col-12 col-xl-10">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-body p-5" id="invoiceArea">
                
                <!-- Receipt Header -->
                <div class="text-center border-bottom pb-4 mb-4">
                    <h2 class="fw-bold text-dark mb-1"><?php echo e($invoice->shop->name ?? 'Z-POS SYSTEM'); ?></h2>
                    <p class="text-muted mb-0"><?php echo e($invoice->shop->address ?? 'Dar es Salaam, Tanzania'); ?></p>
                    <p class="text-muted mb-0">Tel: <?php echo e($invoice->shop->phone ?? '+255 123 456 789'); ?></p>
                ...
                <div class="row mb-4">
                    <div class="col-sm-6">
                        ...
                        <?php if($invoice->customer): ?>
                            <h5 class="fw-bold mb-0"><?php echo e($invoice->customer->name); ?></h5>
                            <?php if($invoice->customer->phone): ?> <p class="text-muted mb-0"><?php echo e($invoice->customer->phone); ?></p> <?php endif; ?>
                            <?php if($invoice->customer->address): ?> <p class="text-muted mb-0"><?php echo e($invoice->customer->address); ?></p> <?php endif; ?>
                        <?php else: ?>
                            <h5 class="fw-bold mb-0 text-muted fst-italic"><?php echo e(__('Walk-in Customer')); ?></h5>
                        <?php endif; ?>
                    </div>
                    <div class="col-sm-6 text-sm-end mt-4 mt-sm-0">
                        <h6 class="fw-bold text-muted small text-uppercase mb-1"><?php echo e(__('Invoice Details:')); ?></h6>
                        <h5 class="fw-bold text-primary mb-1"><?php echo e($invoice->reference_no); ?></h5>
                        <p class="text-muted mb-0">Date: <?php echo e(\Carbon\Carbon::parse($invoice->sale_date)->format('M d, Y')); ?></p>
                        <p class="text-muted mb-0">Method: <?php echo e($invoice->payment_method); ?></p>
                    </div>
                </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-5">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold"><?php echo e(number_format($invoice->net_total_amount)); ?> TSh</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fs-5 fw-bold text-primary"><?php echo e(number_format($invoice->net_total_amount)); ?> TSh</span>
                        </div>
                        
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted fw-medium"><?php echo e(__('Amount Paid:')); ?></span>
                            <span class="fw-bold text-success"><?php echo e(number_format($invoice->paid_amount)); ?> TSh</span>
                        </div>
                        <?php if($invoice->net_total_amount - $invoice->paid_amount > 0): ?>
                            <div class="d-flex justify-content-between text-danger">
                                <span class="fw-medium"><?php echo e(__('Balance Due:')); ?></span>
                                <span class="fw-bold"><?php echo e(number_format($invoice->net_total_amount - $invoice->paid_amount)); ?> TSh</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="text-center mt-5 pt-4 border-top">
                    <p class="text-muted small fst-italic mb-2"><?php echo e($invoice->shop->receipt_message ?? 'Thank you for your business!'); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\invoices\show.blade.php ENDPATH**/ ?>