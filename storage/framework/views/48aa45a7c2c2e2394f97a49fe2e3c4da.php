...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3">
    <h2 class="fw-bold mb-0"><?php echo e(__('Create Category')); ?></h2>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_service" name="is_service" value="1" <?php echo e(old('is_service') ? 'checked' : ''); ?>>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-success px-4">
                            <i class="bi bi-check-circle me-1"></i> <?php echo e(__('Save Category')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Z-pos\resources\views\categories\create.blade.php ENDPATH**/ ?>